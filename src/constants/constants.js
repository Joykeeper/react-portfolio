export const projects = [
  {
    title: 'FictionLib',
    description: "Welcome to FictionLib, a unique social network designed for book and film enthusiasts. With FictionLib, you can create an account, explore various books and films, track your progress, rate what you've read or watched, and interact with others who share your interests.",
      image: '/images/fictionlib.png',
      tags: ['Mongo', 'Express', 'React', 'Node'],
    source: 'https://github.com/Joykeeper/fictionlib',
    visit: 'https://fictionlib.vercel.app/',
    id: 0,
  },
  {
...
export const TimeLineData = [
  ...
  { year: 2018, text: 'Learned Python, developed diverse programs', },
  { year: 2019, text: 'Learned HTML/CSS, JavaScript', },
  { year: 2021, text: 'Dived into React, developed FictionLib', },
  { year: 2023, text: 'Started Computer Science degree', },
  { year: 2024, text: 'Improving and strengthening my skills', },
];

export const AccomplishmentsData = [
  { number: 10, text: 'Exciting Projects'},
  { number: 500, text: 'Code problems solved', },
  { number: 5, text: 'Languages', },
];
